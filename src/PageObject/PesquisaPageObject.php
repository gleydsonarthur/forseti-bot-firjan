...
use Forseti\Bot\Firjan\Parser\PesquisaParser;

class PesquisaPageObject extends AbstractPageObject
{
    ...
    //falta criar mais métodos como esse, para deixar os parâmetros dinâmicos
    ...
    public function post()
    {
        ...
        $this->info('Buscando licitacoes', ['situacao' => $this->situacao, 'modalidade' => $this->modalidade]);

        return new PesquisaParser($resp->getBody()->getContents());
    }
}
